...
function App() {
  ...
  return (
    <body>
      <MDBContainer fluid className="bg-dark" style={{ backgroundColor: "#eee" }}>
      <MDBRow className="d-flex justify-content-center">
        <MDBCol md="10" lg="8" xl="6" >
          <MDBCard id="chat2" style={{ borderRadius: "15px" }} className='bg-dark text-light'>
            ...
            <MDBCardFooter className="text-muted d-flex justify-content-start align-items-center p-3">
              ...
              <button className='text-light btn' onClick={handleButton}>Enviar</button>
            </MDBCardFooter>
          </MDBCard>
        </MDBCol>
      </MDBRow>
